...
public class JavaScriptUIInjector {
    ...
    /**
     * Injects an JavaScript UI overlay into the current document.
     * The UI consists of:
     * - A neon-themed control panel at the top that auto-hides when the mouse is away.
     *   It includes a search bar, and buttons for Search, Refresh, Home, Settings, and About.
     ...
     * provided by the local resources (using the settingsUrl and aboutUrl).
     */
    private void injectUI() {
        ...
        // Build the UI script. Note that we use String.format to inject settingsUrl and aboutUrl.
        String uiScript = String.format("""
            (function() {
                // --- Neon Dark Mode Style Variables ---
                var neonBackground = '#1e1e1e';
                var neonAccent = '#00ffff'; // Neon cyan for accents.
                var neonShadow = '0 0 15px ' + neonAccent;
                var neonFont = 'Roboto, sans-serif';
                ...
                if (!controls) {
                    ...
                    controls.style.background = neonBackground;
                    controls.style.padding = '10px';
                    controls.style.border = '1px solid ' + neonAccent;
                    controls.style.boxShadow = neonShadow;
                    controls.style.zIndex = '10000';
                    controls.style.fontFamily = neonFont;
                    ...
                    searchButton.style.background = neonAccent;
                    searchButton.style.border = 'none';
                    searchButton.style.borderRadius = '3px';
                    searchButton.style.color = neonBackground;
                    ...
                    refreshButton.style.background = neonAccent;
                    refreshButton.style.border = 'none';
                    refreshButton.style.borderRadius = '3px';
                    refreshButton.style.color = neonBackground;
                    ...
                    homeButton.style.background = neonAccent;
                    homeButton.style.border = 'none';
                    homeButton.style.borderRadius = '3px';
                    homeButton.style.color = neonBackground;
                    ...
                    settingsButton.style.background = neonAccent;
                    settingsButton.style.border = 'none';
                    settingsButton.style.borderRadius = '3px';
                    settingsButton.style.color = neonBackground;
                    ...
                    aboutButton.style.background = neonAccent;
                    aboutButton.style.border = 'none';
                    aboutButton.style.borderRadius = '3px';
                    aboutButton.style.color = neonBackground;
                    ...
                    hideButton.style.background = neonAccent;
                    hideButton.style.border = 'none';
                    hideButton.style.borderRadius = '3px';
                    hideButton.style.color = neonBackground;
                ...
                if (!document.getElementById('js-status-bar')) {
                    ...
                    statusBarContainer.style.background = neonBackground;
                    statusBarContainer.style.borderTop = '1px solid ' + neonAccent;
                    statusBarContainer.style.padding = '5px 10px';
                    statusBarContainer.style.fontFamily = neonFont;
                    ...
                    statusText.style.color = neonAccent;
                    ...
                    progressBar.style.background = neonAccent;
